...
export default function AlumniDirectoryConnectScreen() {
  ...
  const handleMessage = () => {
    router.push({
      pathname: '/message',
      params: { userId: selected.id, name: selected.name },
    });
  };
    ...
    <>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          {/* Message button instead of Connect */}
...
const styles = StyleSheet.create({
  ...
  messageButtonText: { color: '#fff', fontSize: 18, fontWeight: '700' },
